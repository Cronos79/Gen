...
#include <sstream>
#include "win32_windows_throw_macros.h"
...
void win32_window::EnableCursor() noexcept
{
	cursorEnabled = true;
	ShowCursor();
	FreeCursor();
...
void win32_window::DisableCursor() noexcept
{
	cursorEnabled = false;
	HideCursor();
	ConfineCursor();
...
bool win32_window::CursorEnabled() const noexcept
{
